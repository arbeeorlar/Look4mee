...
/**
 * Created by sp_developer on 10/7/16.
 */
public class SkillsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SkillsAdapter(Context context, ArrayList<String> Item) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder instanceof SkillsViewHolder){
            ...
            skillsViewHolder.skill_name.setText(this.Item.get(position).toString());
        }
